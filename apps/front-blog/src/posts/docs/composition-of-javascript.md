...
![window, JavaScript, DOM, BOM](/apps/front-blog/public/images/posts/composition-of-javascript/1.webp?raw=true)

## 1. `window` 객체

***JavaScript***의 <u>최상위(루트) 객체</u>이자, 모든 객체가 소속된 <u>전역(***Global***)</u> 객체이다. 어디서든 접근이 가능하다고 하여 전역 객체라 불리며, 객체화된 수많은 구성 요소들로 이루어져 있다.

![window object](/apps/front-blog/public/images/posts/composition-of-javascript/2.webp?raw=true)
...
![Document Object](/apps/front-blog/public/images/posts/composition-of-javascript/3.webp?raw=true)

### 3-1. ***DOM***의 구조 (The ***HTML*** ***DOM*** tree of objects)

![The HTML DOM tree of objects](/apps/front-blog/public/images/posts/composition-of-javascript/4.webp?raw=true)
...
![navigator object](/apps/front-blog/public/images/posts/composition-of-javascript/5.webp?raw=true)
...
![screen object](/apps/front-blog/public/images/posts/composition-of-javascript/6.webp?raw=true)

### 4-3. `location`

`location` 객체는 ***URL*** 주소에 대한 정보를 제공하여, 현재 ***URL***을 읽을 수 있게 해주고 새로운 ***URL***로 변경(redirect)할 수 있게 해준다.

![location object](/apps/front-blog/public/images/posts/composition-of-javascript/7.webp?raw=true)
...
![history object](/apps/front-blog/public/images/posts/composition-of-javascript/8.webp?raw=true)
