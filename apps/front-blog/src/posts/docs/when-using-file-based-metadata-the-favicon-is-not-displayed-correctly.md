...
- 개발자 도구를 켜지 않은 경우의 툴팁.
    ...
    ![alt text](/apps/front-blog/public/images/posts/when-using-file-based-metadata-the-favicon-is-not-displayed-correctly/1.webp)

- 개발자 도구를 켠 경우의 툴팁.

    ![alt text](/apps/front-blog/public/images/posts/when-using-file-based-metadata-the-favicon-is-not-displayed-correctly/2.webp)

- 개발자 도구를 켠 상태로, 마우스 좌측 버튼을 길게 누르고 있는 경우.

    ![alt text](/apps/front-blog/public/images/posts/when-using-file-based-metadata-the-favicon-is-not-displayed-correctly/3.webp)
